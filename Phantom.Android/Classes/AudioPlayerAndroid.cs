...
public class AudioPlayerAndroid :  IAudioPlayer, IAudioDecoderCallback
{
    ...
    string codec = "opus";
    int sampleRate = Phantom.Meta.Config.VoIP_sampleRate;
    int bitRate = Phantom.Meta.Config.VoIP_bitRate;
    int channels = Phantom.Meta.Config.VoIP_channels;
